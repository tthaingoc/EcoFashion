  ...
  const selectedSubtotal = useMemo(
    () =>
      selectedIds
        ...
        .filter(Boolean)
        .reduce((sum, i: any) => sum + i.price * i.quantity, 0),
    [selectedIds, items]
  );
    ...
    return (
      <Box sx={{ minHeight: "100vh", bgcolor: "#f8fafc" }}>
        ...
        <Container maxWidth="md" sx={{ py: 8 }}>
          <Card
            sx={{ textAlign: "center", p: 6, borderRadius: 3, boxShadow: 3 }}
          >
            <ShoppingCart sx={{ fontSize: 80, color: "#e5e7eb", mb: 3 }} />
            <Typography
              variant="h5"
              sx={{ mb: 2, fontWeight: "bold", color: "#374151" }}
            >
              ...
              <CardContent sx={{ p: 0 }}>
                ...
                {Object.entries(grouped).map(([sellerId, sellerItems]) => {
                  const sellerName =
                    ...
                    `Nhà cung cấp ${sellerId.substring(0, 6)}`;
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      variant="subtitle2"
                      sx={{ fontWeight: "bold", color: "#0284c7" }}
                    >
